...
# ('white','smoke','light_gray','gray','dark_gray','black','red','orange','yellow','lime','green','turquoise','cyan','azure','blue','violet','magenta','pink','brown','olive','peach','gold','salmon')
player = Entity(name='o', color=color.azure)
cursor = Tooltip(player.name, color=player.color, origin=(0,0), scale=8, enabled=True)
cursor.background.color = color.
